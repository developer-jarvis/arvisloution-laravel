        ...
        <div class="row justify-content-start ">
            ...
            <div class="col-md-8 right-side-bar">
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/facebook-ads/facebook-basic-leads.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h3>Basic Instagram + Facebook Ads</h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                                <li>Instagram account & Facebook Business Page Create</li>
                                <li>Instagram account & Facebook Page Optimization
                                </li>
                                <li>Instagram account & Facebook page profile & Cover Photo Designs
                                </li>
                                <li>Instagram account & Facebook page poster & Campaigns poster designs
                                </li>
                                <li>Lead Up to 50 to 500
                                </li>
                                <li>Reach Maximum People ( 35000 - 50000 Reach )
                                </li>
                                <li>Brand Promotion</li>
                                <li>Meta Campaigns Strategy
                                </li>
                                <li>Instagram & Facebook Goal Ad Setup
                                </li>
                                <li>Meta Ads Setup
                                </li>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/facebook-ads/standerd-facebook-ads.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h3>Standerd Instagram + Facebook Ads</h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                                <li>Instagram account & Facebook Business Page Create</li>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/facebook-ads/advance-facebook-ads.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h3>Custom Instagram + Facebook Ads
                        </h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/facebook-ads/custom-facebook-ads.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
