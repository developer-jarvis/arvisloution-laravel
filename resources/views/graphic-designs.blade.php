        ...
        <div class="row justify-content-start ">
            ...
            <div class="col-md-8 right-side-bar">
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/graphic-designs/logo-designs.webp" alt=""
                            class="img-fluid">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="py-2">
                            <ul>
                                ...
                                <li>The importance of high-resolution file formats
                                </li>
                                <li>Unique and Creative Logo Concepts
                                </li>
                                <li>Professional Logo Design
                                </li>
                                <li>Icon and Symbol Design
                                </li>
                                <li>High-Resolution Output
                                </li>
                                <li>Unique and Creative Logo Concepts
                                </li>
                                <li>Brand Consistency
                                </li>
                                <li>Logo Redesign Services
                                </li>
                                <li>Competitive Market Analysis
                                </li>
                                <li>Timely Delivery of Design Concepts
                                </li>
                                <li>Affordable Logo Design Packages
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/graphic-designs/company-branding.webp" alt=""
                            class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="py-2">
                            <ul>
                                <li>Logo Design (Brand Identity Development)
                                </li>
                                <li>Brand Collateral Design
                                </li>
                                <li>Business Card Design
                                </li>
                                <li>Letterhead and Stationery Design
                                </li>
                                <li>Brand Guidelines Documentation
                                </li>
                                <li>Brand Audit and Analysis
                                </li>
                                <li>Naming and Branding for New Products/Services
                                </li>
                                <li>Naming and Branding for New Products/Services
                                </li>
                            </ul>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/graphic-designs/brand-promotions.webp" alt=""
                            class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    ...
                    <div class="col-md-8">
                        <h3>BRAND PROMOTION Branding</h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                                ...
                                <li>Flyer Design, Poster Design
                                </li>
                                <li>Product Label Design
                                </li>
                                <li>Business Card Design
                                </li>
                                <li>Banner and Display Ads
                                </li>
                                <li>Poster Designs
                                </li>
