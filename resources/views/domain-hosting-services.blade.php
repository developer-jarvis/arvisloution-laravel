        ...
        <div class="row justify-content-start ">
            ...
            <div class="col-md-8 right-side-bar">
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/domain-hosting/domain-booking.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h3>Domain Booking Services</h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                                <li>Brand Name Creativity</li>
                                <li>Target Audience Appeal
                                </li>
                                <li>Uniqueness & Pronounceability
                                </li>
                                <li>Social Media Availability
                                </li>
                                <li>Trademark Availability
                                </li>
                                <li>Industry Alignment
                                </li>
                                <li>Competitor Analysis
                                </li>
                                <li>Search Engine Optimization (SEO) Considerations
                                </li>
                                <li>Cultural Sensitivity</li>
                                <li>Brandable vs. Descriptive
                                </li>
                                <li>Availability Across Top-Level Domains (TLDs)
                                </li>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/domain-hosting/cloud-hosting.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <div class="py-2">
                            <ul>
                                ...
                                <li>Less then 1 second response time
                                </li>
                                <li>DIgital Ocean / Linode India Datacenter
                                </li>
                                <li>99.99% Uptime
                                </li>
                                ...
                                <li>Imunify360 Anti-Virus
                                </li>
                                <li>5 Days Auto Backups
                                </li>
                                <li>Professional Emails</li>
                                <li>DDOS Protection
                                </li>
                                <li>24 by 7 Professional Support
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center align-items-center bg-light mb-3">
                    <div class="col-md-4">
                        <img src="assets/images/domain-hosting/hosting.webp" alt="" class="img-fluid">
                        <div class="py-4 text-center">
                            <a href="" class="btn btn-primary">Order Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h3>VPS & Dadicated Hosting</h3>
                        <hr>
                        <div class="py-2">
                            <ul>
                                <li>Customizable Resource Allocation</li>
                                <li>High Performance NVME SSD Storage
                                </li>
                                <li>Dedicated IP Addresses
                                </li>
                                <li>24/7 Technical Support
                                </li>
                                <li>Proactive Security Measures
                                </li>
                                <li>Advanced Server Monitoring
                                </li>
                                <li>Choice of Operating Systems</li>
                                <li>Control Panel Options
                                </li>
                                <li>Server Management Dashboard
                                </li>
                                <li>Root Access
                                </li>
                                <li>Firewall Configuration Options</li>
                                <li>Load Balancing (for Dedicated Hosting)
                                </li>
                                <li>DDoS Protection</li>
                                <li>Data Center Location Options
                                </li>
                                <li>Network Uptime SLA
                                </li>
